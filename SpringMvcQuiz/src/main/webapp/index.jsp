...
<body>
	<button onclick="location.href='ilike/movie'" class="btn btn-outline-info">제목을 메시지로 받아서 출력하고 그아래 이미지_result1</button><br>
	<button onclick="location.href='school/myinfo'" class="btn btn-outline-success">get방식 테이블출력(이름,학교,학년,학교주소)_result2</button><br>
	<button onclick="location.href='shop/ipgo'" class="btn btn-outline-danger">post방식_dto_테이블출력(상품명,카테고리,색상,가격)_result3</button><br>
